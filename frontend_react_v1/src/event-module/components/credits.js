                ...
                <div className='row'>
                    ...
                    <div className='col-6 text-center'>
                        ...
                        <div className='card-text'>
                            <img src='https://images.unsplash.com/photo-1514306191717-452ec28c7814?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1469&q=80' style={{height: '100px', width: '100px'}} alt='Rob Laughter on Unsplash'/>
                        ...
                        <div className='card-text'>
                            <img src='https://images.unsplash.com/photo-1522158637959-30385a09e0da?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80' style={{height: '100px', width: '100px'}} alt='Rob Laughter on Unsplash'/>
